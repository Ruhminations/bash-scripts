...
echo "to mount right now, run: sudo s3fs $2 /bedrock_bucket -o passwd_file=/etc/passwd-s3fs -o url=https://$3.compat.objectstorage.$4.oraclecloud.com -o use_path_request_style -o kernel_cache -o multipart_size=128 -o parallel_count=50 -o multireq_max=100 -o max_background=1000 -o endpoint=$4"
